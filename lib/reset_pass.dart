...
class MyResetPassPage extends StatefulWidget {
  const MyResetPassPage({super.key});

  @override
  State<MyResetPassPage> createState() => _MyResetPassPageState();
}

class _MyResetPassPageState extends State<MyResetPassPage> {
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const MyResetPassPage()),
                          );
                        },
                        child: Text("Register"),
                      ),
